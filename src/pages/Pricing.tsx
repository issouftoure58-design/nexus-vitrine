...
const plans = [
  {
    ...
    users: 1,
    features: [
      '7 modules métier universels',
      'Facturation & Paiements Stripe',
      'CRM Clients (500 max)',
      'Dashboard & Stats basiques',
      'Assistant Admin IA (lecture)',
      'Notifications email',
      'Documents & Fichiers (500 MB)',
      'SENTINEL Monitor basic',
      'Support email (48h)',
      '1 utilisateur',
    ],
    cta: 'Commencer',
  ...
  },
  {
    ...
    features: [
      ...
      'CRM avancé (clients illimités)',
      'Marketing automation',
      'Stock & Inventaire',
      'Analytics avancés + Exports',
      'Assistant Admin IA PRO (exécution)',
